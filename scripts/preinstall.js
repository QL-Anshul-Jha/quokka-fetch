...
try {
  ...
  if (!email || !email.endsWith('@quokkalabs.com')) {
    console.error('\x1b[31m%s\x1b[0m', '❌ ERROR: blazion is a private package restricted to @quokkalabs.com users.');
    ...
    console.log('\x1b[32m%s\x1b[0m', `✅ blazion domain verification passed for: ${email}`);
  }
} catch (error) {
